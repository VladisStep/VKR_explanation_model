...
model = keras.models.load_model(my_utils.path_to_project + 'Lime/Alzheimer_two_classes/Models/my_alzheimer_model.h5')
...
path_to_img_to_explain = path_to_project + "Datasets/Alzheimer_two_classes/test/Demented/27 (9).jpg"
...
plt.savefig(path_to_project + 'Lime/Alzheimer_two_classes/Graphs/alz.png')
plt.show()
