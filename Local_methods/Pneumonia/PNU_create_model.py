...
PATH_VALID_DS = PATH_PROJECT + "Datasets/chest_xray/val"
PATH_TEST_DS = PATH_PROJECT + "Datasets/chest_xray/test"
PATH_SAVE_MODEL = PATH_PROJECT + "Local_methods/Pneumonia/Models/"
...
checkpoint_cb = tf.keras.callbacks.ModelCheckpoint("pneumonia_model.h5",
                                                   save_best_only=True)
